...
public class org_eventAdapter extends RecyclerView.Adapter<org_eventAdapter.myViewHolder> implements Filterable {
    ArrayList<eventModel> eventdatalist;
    ArrayList<eventModel> backup;
    int done = 1;
    Context context;

    public org_eventAdapter(ArrayList<eventModel> eventlist) {
            ...
            if (currentDate.before(endDate)) {
                ...
                holder.parent_layout_event.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), eventDetailsOrg.class);
