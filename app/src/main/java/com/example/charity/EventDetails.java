...
public class EventDetails extends AppCompatActivity {
    ...
    private void ValidatePostInfo() {
        ...
        documentReference.set(postMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(EventDetails.this, "You are going", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void initiateLocationRetreiving() {
        ...
        if (ActivityCompat.checkSelfPermission(EventDetails.this
                ...
                && ActivityCompat.checkSelfPermission(EventDetails.this
            ...
            fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if (location != null) {
                        ...
                        if (ActivityCompat.checkSelfPermission(EventDetails.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(EventDetails.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            // TODO: Consider calling
                            //    ActivityCompat#requestPermissions
                            // here to request the missing permissions, and then overriding
                            //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
